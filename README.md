...
See the Wiki for up-to-date [Installation Instructions](https://github.com/petervanderdoes/gitflow-inno/wiki/Installation).


## Integration with your shell

For those who use the [Bash](http://www.gnu.org/software/bash/) or [ZSH](http://www.zsh.org)
shell, you can use Peter Van Der Does' [fork of git-flow-completion](https://github.com/petervanderdoes/git-flow-completion)
...
* See the [FAQ](http://github.com/jbinnography/gitflow-inno/wiki/FAQ) section
of the project Wiki.
...
list](http://github.com/jbinnography/gitflow-inno/issues) on Github to provide that
feedback.
...
```shell
git clone -b master git@github.com:<username>/gitflow-inno.git
cd gitflow-inno
```
